    ...
    <section class="sub1-header">
        ...
        <div class="navbar">
            ...
            if ($connection->connect_error) {
                ...
                $stmt = $connection->prepare("insert into request(firstName, lastName, birthday, email, pnumber, address, bloodgroup, gender)
		      values(?, ?, ?, ?, ?, ?,?, ?)");
                $stmt->bind_param("ssssisss", $firstName, $lastName, $birthday, $email, $pnumber, $address, $bloodgroup, $gender);
                $stmt->execute();
